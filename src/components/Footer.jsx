      ...
      <div className="max-w-7xl mx-auto px-6 py-16 grid grid-cols-1 md:grid-cols-4 gap-10">
        ...
        <div className="md:col-span-2">
          ...
          <div className="mt-5 flex gap-3">
            {/* TikTok */}
            <a href="https://tiktok.com/@n0vaweb" target="_blank" rel="noreferrer" aria-label="TikTok" className="w-9 h-9 rounded-full flex items-center justify-center bg-white/[0.05] border border-white/[0.08] text-white hover:border-violet-500/50 hover:bg-white/[0.10] transition-colors">
            ...
            {/* Instagram */}
            <a href="https://instagram.com/novaaa.web" target="_blank" rel="noreferrer" aria-label="Instagram" className="w-9 h-9 rounded-full flex items-center justify-center bg-white/[0.05] border border-white/[0.08] text-white hover:border-violet-500/50 hover:bg-white/[0.10] transition-colors">
            ...
            {/* LinkedIn */}
            <a href="https://linkedin.com/in/othmanebouakline" target="_blank" rel="noreferrer" aria-label="LinkedIn" className="w-9 h-9 rounded-full flex items-center justify-center bg-white/[0.05] border border-white/[0.08] text-white hover:border-violet-500/50 hover:bg-white/[0.10] transition-colors">
        ...
        <div>
          ...
          <ul className="space-y-2.5 text-sm text-zinc-500">
            <li><a href="mailto:onovaweb.pro@gmail.com" className="hover:text-white transition-colors">onovaweb.pro@gmail.com</a></li>
