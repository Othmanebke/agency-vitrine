    ...
    <header className="border-b border-zinc-800">
      <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
        <div className="flex items-center gap-4">
          <div className="font-bold text-lg">AGENCE</div>
        </div>

        <nav className="hidden md:flex items-center gap-6">
          <a href="#services" className="text-sm opacity-80 hover:opacity-100">Services</a>
          <a href="#about" className="text-sm opacity-80 hover:opacity-100">À propos</a>
      ...
      {open && (
        <div className="md:hidden bg-zinc-900 border-t border-zinc-800">
          <div className="px-6 py-4 space-y-3">
            ...
            <a href="#about" onClick={()=>setOpen(false)} className="block">À propos</a>
