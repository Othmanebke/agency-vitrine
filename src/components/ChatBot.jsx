...
const TREE = {
  start: {
    bot: "Salut ! 👋 Bienvenue chez NovaWeb. Pour mieux t'orienter, quel est ton projet aujourd'hui ?",
    options: [
        ...
        {open && (
          ...
          >
            ...
            <div className="flex items-center gap-3 px-4 py-3 border-b border-white/[0.07] bg-gradient-to-r from-violet-600/20 to-pink-600/10 flex-shrink-0">
              <div className="w-8 h-8 rounded-full bg-gradient-to-br from-violet-500 to-pink-500 flex items-center justify-center text-white font-black text-sm flex-shrink-0">N</div>
              <div className="flex-1 min-w-0">
                <div className="font-bold text-sm leading-tight">NovaWeb</div>
            ...
            <div className="flex-1 overflow-y-auto px-4 py-4 space-y-3 scroll-smooth" style={{ overflowY: 'auto' }}>
              <AnimatePresence initial={false}>
                {messages.map(msg => (
                  ...
                  >
                    {msg.role === 'bot' && (
                      <div className="w-6 h-6 rounded-full bg-gradient-to-br from-violet-500 to-pink-500 flex items-center justify-center text-white text-[10px] font-black flex-shrink-0 mb-0.5">N</div>
                    )}
                    <div
                ...
                {typing && (
                  ...
                  >
                    <div className="w-6 h-6 rounded-full bg-gradient-to-br from-violet-500 to-pink-500 flex items-center justify-center text-white text-[10px] font-black flex-shrink-0">N</div>
